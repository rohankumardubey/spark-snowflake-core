...
# Build docker image
docker build \
--build-arg SPARK_URL=https://archive.apache.org/dist/spark/spark-3.3.0/spark-3.3.0-bin-hadoop2.tgz \
--build-arg SPARK_BINARY_NAME=spark-3.3.0-bin-hadoop2.tgz \
